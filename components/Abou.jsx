...
const Abou = () => {
  return (
<div className="hidden md:flex md:flex-col  bg-black ">
    <div className='md:flex md:flex-row w-full bg-black'>
        <div className='w-full flex flex-col pt-4'>
            <div className=' p-6  pt-8 flex flex-row justify-start gap-4 pb-0 border-l-8 border-[rgb(140,254,62)]' >
              <div className="leading-[100px] ">
                <span className="pl-[3rem] text-[100px] leading-[100px] font-bold text-white ">
                 Explore
                 <br />
                </span>
                <span className="pl-[2.9rem] text-[180px] font-bold  text-limee">
                  Startups
                </span>
              </div>
              <div className="absolute p-0 right-[20rem] z-[0]">
              <svg className='h-[333px]' viewBox="0 0 499 499" fill="none" xmlns="http://www.w3.org/2000/svg">
<g opacity="0.2">
...
<path d="M141.842 367.536C135.736 371.679 127.142 372.098 116.931 371.905C94.0007 371.415 78.0879 348.456 86.3961 326.779C89.5563 318.563 96.3539 307.502 99.6953 305.239C100.423 304.757 100.981 304.057 101.289 303.239C101.596 302.422 101.639 301.528 101.409 300.685C101.18 299.842 100.691 299.092 100.012 298.543C99.3328 297.994 98.4977 297.672 97.6254 297.625C84.9176 296.754 72.2837 300.16 61.7353 307.3C35.5463 325.051 17.777 406.202 17.777 406.202C17.777 406.202 99.7729 419.833 125.962 402.082C136.533 394.95 144.396 384.467 148.283 372.321C149.38 368.483 145.073 365.243 141.842 367.536Z" fill="#F4F4F4"/>
            ...
            <div className='flex flex-row justify-between  px-0 pl-5'>
             <div className="p-16 pr-0 ">
                <div className="pb-4"> 
                  <span className="text-white text-start md:text-3xl lg:text-5xl font-normal font-['Google Sans'] leading-10">What are </span><span className="text-slate-500 text-5xl font-normal font-['Google Sans'] leading-10"> </span><span className="text-white md:text-3xl lg:text-5xl font-medium font-['Google Sans'] leading-10">Startups ?</span>
                </div>
                <div className="pb-4">      
                  <span className="text-white text-start md:text-3xl lg:text-5xl font-normal font-['Google Sans'] leading-10">Startup Lifecycle</span>
                </div >
                <div className="pb-4">
                  <span className="text-white text-start md:text-3xl lg:text-5xl font-normal font-['Google Sans'] leading-10">How to Pitch?</span>
                </div>
                <div className="pb-4">
                <span className="text-white text-start md:text-3xl lg:text-5xl font-normal font-['Google Sans'] leading-10" >Market Research</span>
                </div >
                <div className="pb-4">
                  <span className="text-white  text-start md:text-3xl lg:text-5xl font-normal font-['Google Sans'] leading-10">How to get startup ideas?</span>
                </div>
             </div>
             ...
             <div className="flex flex-col justify-center items-center px-0 p-8">
                ...
                <img className=' overflow-hidden h-80 w-100' src="/assets/Dine.png" alt="" />
                <div className="w-96 h-14 p-4 text-white text-center md:text-3xl text-4xl font-bold font-['Google Sans']">Dinesh Nalam</div> 
                <div className="text-center  z-20 relative">
                    <span className="text-[rgb(140,254,62)] p-0 z-20 text-2xl font-bold font-['Google Sans'] leading-10">Lead, GDSC MLRIT<br/></span>
                    <span className="text-[rgb(235,235,235)] text-xl font-normal font-['Google Sans'] leading-relaxed">EY Scholarship Finalist<br/>
                    State Level Pitch Fest Winner</span>
                </div>
             </div>
             {/* <div className="flex items-center w-[48px] px-8 pt-[0rem] justify-center">
            <p className="-rotate-90 text-[rgb(140,254,62)]  text-8xl  font-bold font-['Google Sans']">SPEAKER</p>
        </div> */}
