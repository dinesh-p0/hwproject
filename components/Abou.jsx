        ...
        <div className='w-full flex flex-col pt-4'>
            <div className=' h-auto p-6  pt-8 flex flex-row justify-start gap-4 pb-0 border-l-8 border-[rgb(140,254,62)]' >
              ...
              <div className="absolute p-0 left-[25rem] lg:left-[45rem] z-[0]">
               <svg className='lg:h-[333px] h-[150px]' viewBox="0 0 499 499" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g opacity="0.2">
            ...
            <div className='flex flex-row justify-between  px-0 pl-5'>
             <div className="p-16 pr-0 ">
                <div className="pb-4"> 
                  <span className="text-white text-start text-2xl lg:text-4xl font-normal font-['Google Sans'] leading-10">What are </span><span className="text-slate-500 text-5xl font-normal font-['Google Sans'] leading-10"> </span><span className="text-white text-3xl lg:text-5xl font-medium font-['Google Sans'] leading-10">Startups ?</span>
                </div>
                <div className="pb-4">      
                  <span className="text-white text-start text-2xl lg:text-4xl font-normal font-['Google Sans'] leading-10">Startup Lifecycle</span>
                </div >
                <div className="pb-4">
                  <span className="text-white text-start text-2xl lg:text-4xl font-normal font-['Google Sans'] leading-10">Market Research</span>
                </div>
                <div className="pb-4">
                <span className="text-white text-start text-2xl lg:text-4xl font-normal font-['Google Sans'] leading-10" >How to Pitch?</span>
                </div >
                <div className="pb-4">
                  <span className="text-white  text-start text-2xl lg:text-4xl font-normal font-['Google Sans'] leading-10">How to get startup ideas?</span>
                </div>
             </div>
             ...
             <div className="flex flex-col justify-center items-center px-0 p-8 bg-black">
                ...
                <div className="w-96 h-14 p-4 text-white text-center text-3xl lg:-4xl font-bold font-['Google Sans']">Dinesh Nalam</div> 
                <div className="text-center  z-20 relative">
                    <span className="text-[rgb(140,254,62)] p-0 z-20 text-xl lg:text-2xl font-bold font-['Google Sans'] leading-10">Lead, GDSC MLRIT<br/></span>
                    <span className="text-[rgb(235,235,235)] text-lg lg:text-xl font-normal font-['Google Sans'] leading-relaxed">EY Scholarship Finalist<br/>
